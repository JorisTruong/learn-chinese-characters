...
const GenerateOptions = () => {  
  ...
  const [directions, setDirections] = useState(["lrt"])
    ...
    <div className="site-layout-background" style={{ padding: 24 }}>
        ...
        inputs.map((element, index) => {
          return(
            <Row key={`generate ${index}`} style={{ paddingBottom: 25 }}>
              <Col lg={{ span: 18, offset: 3 }} md={{ span: 18, offset: 3 }} xs={{ span: 24 }}>
                <Card>
                  <Row gutter={[16, 16]}>
                      ...
                      <Row style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                        ...
                        <Col span={24}>
                          <Select
                            ...
                            defaultValue="ltr"
                            onChange={(value) => {
                              let updatedDirections = [...directions]
      ...
      <Row style={{ textAlign: "center" }} gutter={[16, 32]}>
        <Col lg={{span: 2, offset: 10}} md={{span: 2, offset: 10}} xs={{ span: 6, offset: 6}}>
          <Button type="primary" shape="circle" icon={<PlusOutlined />} onClick={() => {
            ...
            setPlaceholders(updatedPlaceholders)
            let updatedPages = [...pages]
            updatedPages[pages.length] = 1
            setPages(updatedPages)
            let updatedDirections = [...directions]
            updatedDirections[directions.length] = "ltr"
            setDirections(updatedDirections)
          }} />
        </Col>
      ...
      <Row style={{ textAlign: "center" }} gutter={[16, 16]}>
        <Col lg={{ span: 2, offset: 11 }} md={{ span: 6, offset: 4 }} xs={{ span: 9 }}>
          <Button type="primary" onClick={() => {console.log(inputs); console.log(fannings); console.log(placeholders); console.log(directions); console.log(pages)}} style={{ width: "100%" }}>Generate</Button>
        </Col>
      </Row>
    </div>
  )
